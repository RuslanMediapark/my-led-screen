...
<section id="main-module">
    ...
    <?php if ($main_module_mode_page === 'media-pilons') :?> 
        ...
        <? else : ?>
            <div class="main-module__block__static">
            <?php if (!empty($main_module_title)) : ?>
            <div>
                <h2 class="section-title animate__animated animate__fadeInUp" data-wow-offset="0"><?= $main_module_title ?? '' ?></h2>
                <?php endif; ?>
                <?php if (!empty($main_module_subtitle)) : ?>
                    <p class="main-module__block-left-subtitle"><?= $main_module_subtitle ?? '' ?></p>
                <?php endif; ?>
                <?php if (!empty($main_module_dignity_title)) : ?>
                    <p class="dignity_title"><?= $main_module_dignity_title ?></p>
                <?php endif; ?>
